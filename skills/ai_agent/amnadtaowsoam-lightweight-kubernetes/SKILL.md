---
id: SKL-lightweight-LIGHTWEIGHTKUBERNETES
name: Lightweight Kubernetes
description: Lightweight Kubernetes provides container orchestration for resource-constrained edge and IoT devices. It uses minimal resource footprints while providing core Kubernetes functionality for edge comput
version: 1.0.0
status: active
owner: "@cerebra-team"
...
skill_id: official_hbKIc86U
enabled_at: 1787232483555
name_zh: 容器K8s运维
---
...
## Skill Composition
* **Depends on**: [Edge Cloud Sync](../75-edge-computing/edge-cloud-sync/SKILL.md)
* **Compatible with**: [Edge AI Acceleration](../75-edge-computing/edge-ai-acceleration/SKILL.md), [Edge Observability](../75-edge-computing/edge-observability/SKILL.md)
* **Conflicts with**: Standard Kubernetes (resource constraints)
* **Related Skills**: [Edge Cloud Sync](../75-edge-computing/edge-cloud-sync/SKILL.md), [Edge AI Acceleration](../75-edge-computing/edge-ai-acceleration/SKILL.md)
