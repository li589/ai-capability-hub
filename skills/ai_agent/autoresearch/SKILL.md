---
name: autoresearch
description: Run Karpathy-style autoresearch optimization on any content.
  Generates 50+ variants, scores with a 5-expert simulated panel, evolves
  winners through multiple rounds, outputs optimized version + full experiment
  log. Use when optimizing landing pages, email sequences, ad copy, headlines,
  form pages, CTA text, or any conversion-focused content. Triggers on 'optimize
  this page', 'run autoresearch', 'score these variants', 'A/B test this copy'.
version: 1.0.2
display_name: autoresearch
display_name_en: Autoresearch
description_zh: Karpathy 风格内容优化，50+ 变体 + 专家评分 + 进化迭代
description_en: Karpathy-style content optimization with 50+ variants, expert
