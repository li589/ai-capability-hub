...
license: Apache-2.0
compatibility: |
  Requires uv (Python package manager) and HTTPS access to das.cn-shanghai.aliyuncs.com. Requires Alibaba Cloud credentials to be available through the default credential chain (AliyunHDMFullAccess permission). DAS Agent ID is optional.
metadata:
  async: true
  timeout: 1800
...
skill_id: official_k748kk54
enabled_at: 1787232575491
version: 1.0.0
name_zh: 阿里云DAS数据库自治助手
---
