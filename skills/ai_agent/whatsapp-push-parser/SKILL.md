---
name: whatsapp-push-parser
version: 1.3.0
description: "WhatsApp Push Parser workflow for foreign-trade teams, with explicit evidence, controlled CRM access, confirmation, and safety boundaries."
description_zh: "解析企业接收接口保存的WhatsApp推送字段，包括账号、联系人、方向、类型、内容、messageId、时间和媒体链接。适用于用户要求WhatsApp消息接收解析、生成相关结果或检查执行边界时。"
---
...
定位：解析企业接收接口保存的WhatsApp推送字段，包括账号、联系人、方向、类型、内容、messageId、时间和媒体链接。边界：处理已接收数据，不主动向询盘云拉取或发送消息。
...
> 解析JSON：{"messageId":"m-1001","accountId":"wa-sales-01","contactKey":"+491701234567","direction":"inbound","messageType":"text","occurredAt":"2026-07-18T09:30:00+02:00","text":"Need 500 pcs, delivery in September","mediaUrl":null}。
