...
display_name: 公众号账号诊断
display_name_en: WeChat Account Analyzer
description_zh: 四维度量化评分诊断公众号健康度，对标行业生成优化建议
description_en: Diagnose WeChat account health with 4-dimensional scoring and optimization tips
...
### 前置条件
- 已安装 Python 3.8+
- 已注册 [红狐Hub](https://redfox.hk/?source=workbuddy) 账号并获取 API Key
...
当用户提到以下任意关键词时自动激活并直接执行诊断，无需等待用户确认：
- "诊断公众号"、"账号分析"、"公众号体检"
