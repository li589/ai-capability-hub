...
- 若返回 `candidates` 数组（有相近账号），自动选择第一个候选账号继续诊断，无需询问用户
...
> *诊断时间：[YYYY-MM-DD] | 数据来源：[红狐数据（redfox.hk）](https://redfox.hk/?source=workbuddy) 更多平台数据、优质数据可前往查看API接口 | 置信度：[高/中/低] | 阅读数>10万显示为10w+*
