...
```bash
# 可选参数: stockCode, industryCode, industryCodeLv1, institutionCode, categoryCode, beginDate, endDate, pageNum, pageSize
investoday-api report/research --method POST
```
...
```bash
# 可选参数: institutionName, pageNum, pageSize
investoday-api report/institutions --method POST
```
