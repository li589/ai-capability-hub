...
- `REDFOX_API_KEY` is provided by [RedFoxHub](https://redfox.hk/settings/api-keys?source=workbuddy) (`https://redfox.hk`?source=workbuddy).
- Please visit [RedFoxHub](https://redfox.hk?source=workbuddy) to register an account and obtain your `REDFOX_API_KEY`.
