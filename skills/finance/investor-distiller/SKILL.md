...
description: 公众号投资博主蒸馏器。通过公众号文章数据，自动提取交易体系、市场判断、表达风格、内容深度、互动特征、热点图谱、
  人设基因七维DNA，输出结构化风格画像 profile。 触发词：蒸馏投资博主、蒸馏大V、蒸馏公众号大V、分析投资博主风格、
  提取交易体系、风格画像、投资博主蒸馏。
display_name: 公众号投资博主蒸馏器
display_name_en: Investor Style Distiller
description_zh: 自动采集公众号文章，提取投资博主交易体系、市场判断等七维DNA风格画像
description_en: Distill seven-dimension style profiles of WeChat investment bloggers.
category: finance
version: 1.0.0
author: 红狐数据
...
前往 [红狐 hub](https://redfox.hk/settings/api-keys?source=workbuddy) 获取 API Key，通过以下方式配置：
...
注册地址：[redfox.hk/login](https://www.redfox.hk/login?source=workbuddy)
