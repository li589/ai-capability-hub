...
homepage: https://workbuddy.com/redfox-data/redfox-community/stock-feed-skill
repository: https://workbuddy.com/redfox-data/redfox-community
...
metadata:
  openclaw:
    ...
    tags:
      ...
      - analysis
display_name: A股每日新闻
display_name_en: A-Share Daily News
description_zh: 从小红书、抖音、公众号三平台聚合A股短讯，内置17个核心关键词一次性查询
description_en: Daily A-share news aggregated from Xiaohongshu, Douyin and WeChat.
category: finance
...
脚本需配置 API Key 使用。从 [红狐数据](https://www.redfox.hk/settings/api-keys?source=workbuddy) 获取个人 Key 并配置环境变量：
...
> 请配置 API Key：`export REDFOX_API_KEY=ak_你的密钥`，注册地址 https://www.redfox.hk/login?source=workbuddy
