...
display_name: A股情报调查员
display_name_en: A-Share Intel Investigator
description_zh: A股全维度情报调查工具，覆盖公司研究、竞品分析、舆情追踪、背景核查、信息交叉验证，输出结构化报告
description_en: Comprehensive A-share intelligence investigation tool covering
  company research, competitor analysis, sentiment tracking, background checks,
  and information verification with structured reporting.
category: finance
version: 1.0.1
author: 马祯
...
**API Key 获取**：前往 [RedFox 官网](https://redfox.hk/?source=workbuddy) 注册，登录后在个人中心获取，格式为 `ak_xxxxxxxx`。新注册用户获赠免费积分。
