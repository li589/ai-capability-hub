---
name: lovstudio-bp
description: 根据项目材料和用户目标，按需编排投资人商业计划书大纲、融资演示文稿、证据核验与专业审校流程；适用于完整 BP、融资 PPT、已有材料续作和逐页润色。
version: 0.2.1
author: LovStudio
source_type: git
git_url: https://github.com/lovstudio/bp-skill
display_name: LovStudio BP 商业计划书工具包
display_name_en: LovStudio BP Skill Kit
description_zh: 根据项目材料和用户目标，按需编排投资人商业计划书大纲、融资演示文稿、证据核验与专业审校流程；支持完整 BP 制作、融资 PPT 生成、已有材料续作和逐页润色。
description_en: "Compose investor-ready business plans on demand: outline, pitch
  deck, evidence verification, and professional review. Supports full BP
  creation, fundraising PPT, existing material revision, and slide-by-slide
  polish."
visibility: public
