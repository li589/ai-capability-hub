...
name: compress
description: |
  Compress natural-language memory files into a shorter terse form to save input tokens  while preserving technical substance, code, URLs, paths, commands, and structure.  Use when a user asks to compress a memory or notes file.
install_source: official
install_method: download
skill_id: official_v1rZNruu
enabled_at: 1787231744741
version: 1.0.0
name_zh: 压缩
---
