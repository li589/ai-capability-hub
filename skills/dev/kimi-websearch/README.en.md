...
Kimi WebSearch is an intelligent web search tool. Simply describe what you want to find out in natural language, and it will leverage Kimi's web search capability to deliver the freshest, most comprehensive answers.
...
- Visit [RedFoxHub](https://redfox.hk?source=workbuddy) to register and obtain your `REDFOX_API_KEY`.
...
|--------|---------------|--------|
| Search for info | "Any good movie recommendations lately?" | Latest movie info and reviews |
| Knowledge Q&A | "What are the latest trends in AI agents?" | A structured industry analysis |
| Real-time query | "What's in the news today?" | The latest news roundup |
...
|----------|------|---------|---------|
| Everyday search | General user | "Best phones of 2026" | Quick latest comparison |
...
| Travel planning | Travel enthusiast | "Things to do around Chengdu" | Guides with detailed information |
