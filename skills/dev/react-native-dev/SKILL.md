...
description: >
  React Native and Expo development guide covering components, styling,
  ...
  Use when: building React Native or Expo apps, implementing animations or
  native UI, managing

  state, fetching data, writing tests, optimizing performance, deploying to App
  Store/Play Store,
...
display_name: react-native-dev
display_name_en: react-native-dev
visibility: public
