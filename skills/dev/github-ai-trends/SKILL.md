...
description: Generate GitHub AI trending project reports as formatted text
  leaderboards. Fetches top-starred AI/ML/LLM repos by daily, weekly, or monthly
  period and renders a styled leaderboard. Use when the user asks for AI project
  trends, GitHub trending, AI leaderboard, or wants to see popular AI repos.
description_zh: 生成 GitHub AI 热门项目趋势排行榜报告
description_en: Generate GitHub AI trending project leaderboard reports
version: 1.1.0
display_name: github-ai-trends
display_name_en: github-ai-trends
visibility: public
