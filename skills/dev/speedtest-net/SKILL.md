...
name: speedtest-net
description: |
  Measure internet network speed (download, upload, ping) using speedtest-cli (Speedtest.net). Use when: user asks to "check speed", "run speedtest", "test network speed", "measure bandwidth", "check internet speed", or any request to test/download/upload speed of the host connection. Requires speedtest-cli pre-installed (see setup.md).
install_source: official
install_method: download
skill_id: official_4GJyfXhl
enabled_at: 1787232496778
version: 1.0.0
name_zh: 网络速度测试
---
