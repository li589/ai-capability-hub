...
func main() {
	config, err := wxpay_utility.CreateMchConfig(
		"YOUR_MCHID", "YOUR_CERT_SERIAL_NO",
		"/path/to/apiclient_key.pem", "YOUR_PUB_KEY_ID", "/path/to/wxp_pub.pem",
	)
	...
	request := &UpdateStockBundleRequest{
		...
		UsageRuleDisplayInfo: &UsageRuleDisplayInfo{
			...
			MiniProgramAppid: wxpay_utility.String("wxYOUR_APPID"),
		...
		CouponDisplayInfo: &CouponDisplayInfo{
			...
			EntranceMiniProgram: &EntranceMiniProgram{
				Appid: wxpay_utility.String("wxYOUR_APPID"), Path: wxpay_utility.String("/pages/index/product"),
				EntranceWording: wxpay_utility.String("欢迎选购"), GuidanceWording: wxpay_utility.String("获取更多优惠"),
			},
			EntranceOfficialAccount: &EntranceOfficialAccount{Appid: wxpay_utility.String("wxYOUR_APPID")},
