...
func main() {
	...
	config, err := wxpay_brand_utility.CreateBrandConfig(
		...
		"YOUR_CERT_SERIAL_NO",      // 品牌API证书序列号，如何获取请参考 https://pay.weixin.qq.com/doc/brand/4015407570
		"/path/to/apiclient_key.pem", // 品牌API证书私钥文件路径，本地文件路径
		"YOUR_PUB_KEY_ID",   // 微信支付公钥ID，如何获取请参考 https://pay.weixin.qq.com/doc/brand/4015453439
	...
	request := &UpdateStockBundleRequest{
		...
		UsageRuleDisplayInfo: &UsageRuleDisplayInfo{
			...
			MiniProgramAppid:      wxpay_brand_utility.String("wxYOUR_APPID"),
		...
		CouponDisplayInfo: &CouponDisplayInfo{
			...
			EntranceMiniProgram: &EntranceMiniProgram{
				Appid:           wxpay_brand_utility.String("wxYOUR_APPID"),
...
func UpdateStockBundle(config *wxpay_brand_utility.BrandConfig, request *UpdateStockBundleRequest) (response *StockBundleEntity, err error) {
	...
	if httpResponse.StatusCode >= 200 && httpResponse.StatusCode < 300 {
		...
		if err := json.Unmarshal(respBody, response); err != nil { return nil, err }
		return response, nil
	} else {
...
func (o *UpdateStockBundleRequest) MarshalJSON() ([]byte, error) {
	...
	a := &struct {
		...
		StockBundleId   *string `json:"stock_bundle_id,omitempty"`
		*Alias
	}{ProductCouponId: nil, StockBundleId: nil, Alias: (*Alias)(o)}
...
type StockEntityInBundle struct {
	ProductCouponId *string `json:"product_coupon_id,omitempty"`; StockId *string `json:"stock_id,omitempty"`
	Remark *string `json:"remark,omitempty"`; CouponCodeMode *CouponCodeMode `json:"coupon_code_mode,omitempty"`
	...
	SentCountInfo *StockSentCountInfo `json:"sent_count_info,omitempty"`; State *StockState `json:"state,omitempty"`
	DeactivateRequestNo *string `json:"deactivate_request_no,omitempty"`
	DeactivateTime *time.Time `json:"deactivate_time,omitempty"`; DeactivateReason *string `json:"deactivate_reason,omitempty"`
}
type CouponUsageMethod string
func (e CouponUsageMethod) Ptr() *CouponUsageMethod { return &e }
const (
	COUPONUSAGEMETHOD_OFFLINE CouponUsageMethod = "OFFLINE"; COUPONUSAGEMETHOD_MINI_PROGRAM CouponUsageMethod = "MINI_PROGRAM"
	COUPONUSAGEMETHOD_APP CouponUsageMethod = "APP"; COUPONUSAGEMETHOD_PAYMENT_CODE CouponUsageMethod = "PAYMENT_CODE"
)
type CouponAvailableStoreInfo struct {
	Description *string `json:"description,omitempty"`; MiniProgramAppid *string `json:"mini_program_appid,omitempty"`
	MiniProgramPath *string `json:"mini_program_path,omitempty"`
}
...
type EntranceMiniProgram struct {
	Appid *string `json:"appid,omitempty"`; Path *string `json:"path,omitempty"`
	EntranceWording *string `json:"entrance_wording,omitempty"`; GuidanceWording *string `json:"guidance_wording,omitempty"`
}
type EntranceOfficialAccount struct { Appid *string `json:"appid,omitempty"` }
type EntranceFinder struct {
	FinderId *string `json:"finder_id,omitempty"`; FinderVideoId *string `json:"finder_video_id,omitempty"`
...
const (
	STOCKSTATE_AUDITING StockState = "AUDITING"; STOCKSTATE_SENDING StockState = "SENDING"
	STOCKSTATE_PAUSED StockState = "PAUSED"; STOCKSTATE_STOPPED StockState = "STOPPED"; STOCKSTATE_DEACTIVATED StockState = "DEACTIVATED"
)
type CouponAvailablePeriod struct {
	AvailableBeginTime *string `json:"available_begin_time,omitempty"`; AvailableEndTime *string `json:"available_end_time,omitempty"`
	AvailableDays *int64 `json:"available_days,omitempty"`; WaitDaysAfterReceive *int64 `json:"wait_days_after_receive,omitempty"`
...
const (
	WEEKENUM_MONDAY WeekEnum = "MONDAY"; WEEKENUM_TUESDAY WeekEnum = "TUESDAY"; WEEKENUM_WEDNESDAY WeekEnum = "WEDNESDAY"
	WEEKENUM_THURSDAY WeekEnum = "THURSDAY"; WEEKENUM_FRIDAY WeekEnum = "FRIDAY"; WEEKENUM_SATURDAY WeekEnum = "SATURDAY"; WEEKENUM_SUNDAY WeekEnum = "SUNDAY"
)
