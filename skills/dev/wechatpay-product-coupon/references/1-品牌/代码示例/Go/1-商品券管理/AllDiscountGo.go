		...
		Stock: &StockForCreate{
			...
			CouponDisplayInfo: &CouponDisplayInfo{
				...
				EntranceMiniProgram: &EntranceMiniProgram{
					Appid:           wxpay_brand_utility.String("wxYOUR_APPID"),         // 【条件必填】填写条件：当设置了 EntranceMiniProgram 时必填
				...
				EntranceOfficialAccount: &EntranceOfficialAccount{
					Appid: wxpay_brand_utility.String("wxYOUR_APPID"), // 【条件必填】填写条件：当设置了 EntranceOfficialAccount 时必填
				},
