	...
	request := &CreateProductCouponRequest{
					...
					ChoiceList: []ComboPackageChoice{
						{
							...
							MiniProgramAppid: wxpay_brand_utility.String("wxYOUR_APPID"),                              // 选填，跳转小程序AppID
		...
		StockBundle: &StockForCreate{
			...
			UsageRuleDisplayInfo: &UsageRuleDisplayInfo{
				...
				MiniProgramAppid: wxpay_brand_utility.String("wxYOUR_APPID"),        // 条件必填，支持小程序核销时必填
				...
				CouponAvailableStoreInfo: &CouponAvailableStoreInfo{
					...
					MiniProgramAppid: wxpay_brand_utility.String("wxYOUR_APPID"),          // 选填，门店小程序AppID
			...
			CouponDisplayInfo: &CouponDisplayInfo{
				...
				EntranceMiniProgram: &EntranceMiniProgram{
					Appid:           wxpay_brand_utility.String("wxYOUR_APPID"),         // 必填，小程序AppID
				...
				EntranceOfficialAccount: &EntranceOfficialAccount{
					Appid: wxpay_brand_utility.String("wxYOUR_APPID"), // 必填，公众号AppID
				},
				// 选填，视频号入口
