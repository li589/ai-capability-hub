...
public class CreateStock {
  ...
  public static void main(String[] args) {
    ...
    request.stock.usageRuleDisplayInfo.miniProgramAppid = "wxYOUR_APPID";
    ...
    request.stock.usageRuleDisplayInfo.couponAvailableStoreInfo.miniProgramAppid = "wxYOUR_APPID";
    ...
    request.stock.couponDisplayInfo.entranceMiniProgram.appid = "wxYOUR_APPID";
    ...
    request.stock.couponDisplayInfo.entranceOfficialAccount.appid = "wxYOUR_APPID";
