...
public class CreateStockBundle {
  ...
  public static void main(String[] args) {
    ...
    request.stockBundle.usageRuleDisplayInfo.miniProgramAppid = "wxYOUR_APPID";
    ...
    request.stockBundle.usageRuleDisplayInfo.couponAvailableStoreInfo.miniProgramAppid = "wxYOUR_APPID";
    ...
    request.stockBundle.couponDisplayInfo.entranceMiniProgram.appid = "wxYOUR_APPID";
    ...
    request.stockBundle.couponDisplayInfo.entranceOfficialAccount.appid = "wxYOUR_APPID";
