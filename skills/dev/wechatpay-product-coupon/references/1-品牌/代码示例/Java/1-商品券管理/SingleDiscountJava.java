...
public class SingleDiscountJava {
  ...
  public static void main(String[] args) {
    ...
    request.stock.usageRuleDisplayInfo.miniProgramAppid = "wxYOUR_APPID"; // 条件必填，支持小程序核销时必填
    ...
    request.stock.usageRuleDisplayInfo.couponAvailableStoreInfo.miniProgramAppid = "wxYOUR_APPID"; // 选填，门店小程序AppID
    ...
    request.stock.couponDisplayInfo.entranceMiniProgram.appid = "wxYOUR_APPID"; // 必填，小程序AppID
    ...
    request.stock.couponDisplayInfo.entranceOfficialAccount.appid = "wxYOUR_APPID"; // 必填，公众号AppID
