...
public class SingleDiscountSequentialJava {
  ...
  public static void main(String[] args) {
    ...
    SingleDiscountSequentialJava client = new SingleDiscountSequentialJava(
      ...
      "YOUR_CERT_SERIAL_NO",         // 品牌API证书序列号，如何获取请参考品牌经营平台【安全中心】
      "/path/to/apiclient_key.pem",     // 品牌API证书私钥文件路径，本地文件路径
      "YOUR_PUB_KEY_ID",      // 微信支付公钥ID，如何获取请参考品牌经营平台【安全中心】
    ...
    request.displayInfo.comboPackageList = new ArrayList<>(); // 必填(单品券)，套餐组合列表
    {
      ...
      choice.miniProgramAppid = "wxYOUR_APPID"; // 选填，跳转小程序AppID
    ...
    request.stockBundle.usageRuleDisplayInfo.miniProgramAppid = "wxYOUR_APPID"; // 条件必填，支持小程序核销时必填
    ...
    request.stockBundle.usageRuleDisplayInfo.couponAvailableStoreInfo.miniProgramAppid = "wxYOUR_APPID"; // 选填，门店小程序AppID
    ...
    request.stockBundle.couponDisplayInfo.entranceMiniProgram.appid = "wxYOUR_APPID"; // 必填，小程序AppID
    ...
    request.stockBundle.couponDisplayInfo.entranceOfficialAccount.appid = "wxYOUR_APPID"; // 必填，公众号AppID
