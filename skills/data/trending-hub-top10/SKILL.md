...
dependency:
  ...
  system:
    - mkdir -p output
display_name: 全网聚合热点榜
display_name_en: Trending Hub Top10
description_zh: 基于每小时收录的七大平台热点数据，聚合全网最热TOP10，支持近7天回溯
description_en: Top 10 trending topics aggregated hourly from seven major platforms.
category: search
version: 1.0.0
author: 红狐数据
