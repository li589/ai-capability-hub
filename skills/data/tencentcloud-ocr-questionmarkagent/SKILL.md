...
version: 1.0.3
display_name: 腾讯云试题批改Agent
display_name_en: Tencent Cloud Question Mark Agent
description_zh: 调用腾讯云试题批改Agent接口，面向K12教育场景，支持整卷/单题端到端批改，包含试卷切题、手写答案识别、正误判定、错误分析和知识点输出。支持深度思考模式和多种图片/PDF格式输入。
description_en: Tencent Cloud Question Mark Agent for K12 education. Supports
  full-paper and single-question grading with handwriting recognition, answer
  comparison, error analysis, and knowledge point extraction.
visibility: public
