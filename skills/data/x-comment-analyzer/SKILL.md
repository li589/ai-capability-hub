...
display_name: X作品评论分析
display_name_en: X Comment Analyzer
description_zh: 输入推文链接或ID获取一级评论，支持游标翻页与四维情感分析
description_en: Fetch X (Twitter) post comments with four-dimension sentiment analysis.
