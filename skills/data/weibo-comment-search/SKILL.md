...
display_name: 微博评论分析
display_name_en: Weibo Comment Analysis
description_zh: 通过微博博文链接获取一级评论数据，支持分页浏览和四维情感分析
description_en: Retrieve first-level comments by Weibo post link with pagination and sentiment analysis
category: search
version: 1.0.0
author: 红狐数据
---
