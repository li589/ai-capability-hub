...
description: Deploy frontend and full-stack projects to Tencent EdgeOne Pages
  using the EdgeOne CLI. Use when the user wants to publish, launch, redeploy,
  create a preview deployment, or ship a site to production.
...
metadata:
  author: edgeone
display_name: EdgeOne Pages Deploy
display_name_en: Edgeone Pages Deploy
visibility: public
icon: https://codebuddy-platform-1258344699.cos.accelerate.myqcloud.com/public/45edac6b-2078-4678-89f3-6f9800cf5e5f/avatar/skill/au_8588ecb0-214.svg
