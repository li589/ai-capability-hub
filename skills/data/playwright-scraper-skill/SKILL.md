...
description: Playwright-based web scraping OpenClaw Skill with anti-bot
  protection. Successfully tested on complex sites like Discuss.com.hk.
description_zh: Playwright 隐身网页抓取，支持反爬绕过与验证码处理
description_en: Playwright stealth web scraping with anti-bot bypass & CAPTCHA solving
version: 1.2.0
author: Simon Chan
allowed-tools: Bash
display_name: playwright-scraper-skill
display_name_en: playwright-scraper-skill
visibility: public
