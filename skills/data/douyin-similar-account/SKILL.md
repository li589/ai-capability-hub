...
display_name: 抖音相似账号推荐
display_name_en: Douyin Similar Account
description_zh: 输入抖音账号智能匹配对标账号与头部标杆，深度分析共通点并提供优化建议
description_en: Smart matching for similar Douyin accounts with benchmarking and gap analysis
...
适用于抖音创作者、内容运营、账号投放决策等需要对标参考的场景。基于 [红狐Hub](https://redfox.hk/?source=workbuddy) 数据平台提供支持。
...
### 前置条件
- Python 3.x 运行环境
- RedFox API Key（前往 [红狐Hub 官网](https://redfox.hk/?source=workbuddy) 注册获取，新用户赠送免费积分）
...
| **数据源** | RedFox API（https://redfox.hk/?source=workbuddy） |
...
如有其他问题，可通过以下方式获取帮助：
- 📧 访问 [红狐Hub 官网](https://redfox.hk/?source=workbuddy) 了解更多
