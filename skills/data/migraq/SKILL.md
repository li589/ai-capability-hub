...
description_en: Tencent Cloud Migration expert with cross-cloud resource
  scanning, spec matching, TCO analysis, and migration planning
version: 1.1.6
allowed-tools:
  - Read
  - Write
...
metadata:
  clawdbot:
    ...
    security:
      data_handling: AK/SK 仅在鉴权场景使用，通过环境变量读取，通过 TC3-HMAC-SHA256 签名 header
        传输，不写入文件或日志；售前流程无需 AK/SK
display_name: migraq
display_name_en: migraq
visibility: public
