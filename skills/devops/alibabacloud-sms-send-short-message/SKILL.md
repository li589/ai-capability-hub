...
license: Apache-2.0
compatibility: |
  aliyun-cli >= 3.3.3 dysmsapi plugin (auto-installed) Requires Alibaba Cloud AccessKey configured via `aliyun configure`
metadata:
...
skill_id: official_3wlACZmk
enabled_at: 1787232114729
version: 1.0.0
name_zh: 阿里云短信服务
---
