...
license: Apache-2.0
compatibility: |
  Requires aliyun CLI with configured credentials (aliyun configure), Python 3.7+, and matplotlib library (pip install matplotlib).
metadata:
  domain: aiops
  owner: vpc-team
...
skill_id: official_k8bgZ1xb
enabled_at: 1787232482890
version: 1.0.0
name_zh: 网络产品巡检
---
