...
license: Apache-2.0
compatibility: |
  Requires sysom-osops CLI. Remote diagnosis requires Alibaba Cloud credentials through AK/SK or an ECS RAM Role, an online Cloud Assistant on the target ECS, and a supported China Mainland or Hong Kong region.
metadata:
  domain: aiops
  product: sysom
  supported_domains:
...
skill_id: official_zkhYYYy0
enabled_at: 1787232597480
version: 1.0.0
name_zh: 阿里云操作系统诊断
---
