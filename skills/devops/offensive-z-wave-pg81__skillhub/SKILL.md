---
name: 攻击性Z-Wave
slug: offensive-z-wave
version: 1.0.0
displayName: 攻击性Z-Wave
description: >
  攻击性Z-Wave专用技能，帮助AI Agent高效完成相关任务。
summary: "Z-Wave attack methodology — sniffing with Z-Force / EZ-Wave / RTL-SDR + ZniffMobile, S0 (legacy) network-key derivation flaw and key reuse, S2 (modern) ECDH commissioning analysis, replay/injection on..."
license: MIT
category: 安全与渗透测试
framework:
  - Claude Code
