...
使用方式:
    ...
    python assets-v1.py upload --file photo.jpg
    python assets-v1.py upload --files a.jpg b.png --public
    python assets-v1.py download --asset-id xxx
    python assets-v1.py download --asset-id xxx --output ./images
...
def main():
    ...
    p_download.add_argument('--token', help='MCP Token（仅本地临时调试；优先使用 LEXIANG_TOKEN）')
