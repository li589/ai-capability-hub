---
name: 攻击性WPA3-SAE
slug: offensive-wpa3-sae
version: 1.0.0
displayName: 攻击性WPA3-SAE
description: >
  攻击性WPA3-SAE专用技能，帮助AI Agent高效完成相关任务。
summary: "攻击性WPA3-SAE专用技能，帮助AI Agent高效完成相关任务。"
license: MIT
category: 安全与渗透测试
framework:
  - Claude Code
...
```bash
git clone https://github.com/1991513ccie-png
cd dragonblood
