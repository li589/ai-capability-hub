...
version: 1.0.0
description: |
  Curated skill bundle for medical device companies, digital health startups and pharma R&D teams. Activates the firm pyramid with RA (Regulatory Affairs), Clinical, R&D and Quality agents pre-configured for FDA/CE compliance, clinical documentation and pharmacovigilance workflows.
...
skill_id: official_M5ckeOXX
enabled_at: 1787231768563
name_zh: 医疗器械与制药企业技能包
---
