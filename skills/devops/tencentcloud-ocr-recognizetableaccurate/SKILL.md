...
description_en: Tencent Cloud RecognizeTableAccurateOCR API for table
  recognition. Supports bordered, borderless, nested, multi-table, and rotated
  table images/PDFs with Excel export capability.
visibility: public
