...
license: Apache-2.0
compatibility: |
  aliyun-cli >= 3.3.3 cams plugin (auto-install) Alibaba Cloud AccessKey required
metadata:
...
skill_id: official_bJJBrib9
enabled_at: 1787232149360
version: 1.0.0
name_zh: 阿里云chatapp消息发送skill
---
## Overview
