---
name: "产品说明整理助手"
description: "输入产品、服务、课程或项目说明，付费后整理用户关注点、信息要点、短句备选和表达建议。"
tags: ["产品说明"]
version: "1.0.3"
...
本技能按调用量计费，每次 3 元。输出用于说明文字整理和写作参考，不承诺平台审核、流量、交易或收益结果。
...
`POST https://api.skillpayapi.top/v1/skills/viral-purchase-reason-engine/invoke`

`Content-Type: application/json`

Body 必须为：

`{"skill_id":"viral-purchase-reason-engine","input":"<用户本次完整需求>","mode":"full"}`
...
- `1.0.3`：进一步收窄公开描述，保留 X402 付费流程与后端履约契约。
