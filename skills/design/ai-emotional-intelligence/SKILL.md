...
description: Argues that emotional intelligence becomes strategically critical precisely because of AI -- not despite it -- and provides leaders with practices for developing the soft skills that constitute the human competitive advantage in an AI-saturated economy. Covers empathy, self-awareness, communication beyond technical details, curiosity, proactive problem-solving, trust-building through vulnerability, and coaching teams in EI. Use when an AI project is failing due to poor leadership connection, when technical leaders cannot engage the workforce emotionally, when employees feel reduced to data points, when building the case for soft skills investment alongside AI investment, or when developing the human capabilities that AI cannot replicate.
version: 1.0.0
...
skill_id: official_L54gcHgM
enabled_at: 1787231717679
name_zh: 人工智能时代的情商
---
...
| Validation | Empathic user and team engagement | Validation requires deep engagement with users and early team members. The ability to understand not just what they say but what they feel -- about the product, the mission, and their role -- separates founders who build loyalty from those who build turnover. |
...
```markdown
# AI-Era Emotional Intelligence Assessment

## Leader EI Profile
| Competency | Current Level (1-5) | Evidence | Development Priority |
|---|---|---|---|
| Empathy | [Score] | [Specific behaviours observed] | [High/Medium/Low] |
| Self-awareness | [Score] | [Specific behaviours observed] | [High/Medium/Low] |
| Communication beyond technical | [Score] | [Specific behaviours observed] | [High/Medium/Low] |
| Curiosity | [Score] | [Specific behaviours observed] | [High/Medium/Low] |
| Proactive problem-solving | [Score] | [Specific behaviours observed] | [High/Medium/Low] |
| Trust through vulnerability | [Score] | [Specific behaviours observed] | [High/Medium/Low] |

## AI Project EI Risk Assessment
| Risk | Likelihood | Impact | Current Mitigation | Recommended Action |
|---|---|---|---|---|
| Technical leader cannot connect emotionally | [H/M/L] | [H/M/L] | [What is in place] | [What should be done] |
| Employees feel like data points | [H/M/L] | [H/M/L] | [What is in place] | [What should be done] |
| Curiosity deficit leads to blind spots | [H/M/L] | [H/M/L] | [What is in place] | [What should be done] |
| Trust erosion due to perceived inauthenticity | [H/M/L] | [H/M/L] | [What is in place] | [What should be done] |

## EI Development Plan
| Week | Practice | Competency Targeted | Success Indicator |
|---|---|---|---|
| 1-2 | [Specific exercise] | [Which competency] | [Observable change] |
| 3-4 | [Specific exercise] | [Which competency] | [Observable change] |
| 5-8 | [Specific exercise] | [Which competency] | [Observable change] |
| 9-12 | [Specific exercise] | [Which competency] | [Observable change] |

## Team EI Baseline and Targets
- **Current team EI strengths:** [What the team does well emotionally]
- **Current team EI gaps:** [Where the team struggles]
- **12-month EI targets:** [Specific, measurable emotional competency goals]
- **Measurement method:** [How progress will be assessed]
```
...
- **[Emotional Intelligence](../frameworks/emotional-intelligence.md)** -- Goleman's five-domain model provides the foundational theory of EI as a general leadership competency; this skill argues that EI becomes strategically imperative specifically because of AI.
- **[AI Stakeholder Balance](ai-stakeholder-balance.md)** -- Balancing stakeholder interests during AI adoption requires the empathy, perspective-taking, and communication skills that EI development provides.
- **[AI Human-Centered Approach](ai-human-centered-approach.md)** -- Human-centred design depends on leaders who can perceive and respond to the emotional experiences of employees interacting with AI systems.
- **[AI Augmentation Not Automation](ai-augmentation-not-automation.md)** -- The creative, judgment-based work that augmentation strategies depend on requires emotionally intelligent teams led by emotionally intelligent leaders.
- **[Emotional Courage](../leadership/emotional-courage.md)** -- Vulnerability, one of the six EI competencies for the AI era, requires emotional courage: the willingness to be seen as uncertain while still leading with conviction.
- **[Trust Equation](../frameworks/trust-equation.md)** -- Trust is the output of consistently practised EI; the trust equation provides the diagnostic for understanding which EI competencies most need development.
