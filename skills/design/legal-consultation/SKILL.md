...
description: General legal consultation entry point to help users identify their legal issues and guide them to appropriate resources. Use when the user asks about any legal question, needs legal advice, is unsure what type of lawyer to consult, or what legal procedure to use.
install_source: official
install_method: download
skill_id: official_u9jv3tFd
enabled_at: 1787231264823
version: 1.0.0
name_zh: 法律咨询
---
...
- [references/legal-areas.md](references/legal-areas.md) — Legal domain overview
- [references/common-issues.md](references/common-issues.md) — Common legal issues guide
