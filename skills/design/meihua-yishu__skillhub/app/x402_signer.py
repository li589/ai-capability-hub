...
async def call_ai_preorder(code_url: str, amount: int = 1, title: str = "梅花易数解卦") -> str:
    ...
    # clawagentpay 网关间歇性 302→50x（fleet 已验证可劣化到持续失败），
    # L1 payload 只构建/签名一次，仅重试 HTTP POST，退避 1.5s×attempt
    last_err = None
