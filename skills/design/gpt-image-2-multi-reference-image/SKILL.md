...
description: 基于 GPT Image 2 多参考图生成 的 AI 图片生成与编辑器，固定调用 GPT Image 2
  的多参考图生成裸接口能力。当用户需要 GPT Image 2、GPT-Image-2、GPTImage2、OpenAI Image 2、ChatGPT
  Images、Image2、多参考图生成、多图融合、多参考图、多图合成、角色风格参考、素材合成、AI图片、AIGC图片 时使用此 Skill。
description_zh: 基于 GPT Image 2 多参考图生成 的 AI 图片生成与编辑器，固定调用 GPT Image 2
  的多参考图生成裸接口能力。当用户需要 GPT Image 2、GPT-Image-2、GPTImage2、OpenAI Image 2、ChatGPT
  Images、Image2、多参考图生成、多图融合、多参考图、多图合成、角色风格参考、素材合成、AI图片、AIGC图片 时使用此 Skill。
version: 1.0.0
...
- 独立占据 `gpt-image-2-multi-reference-image` 搜索入口
...
| 能力 | publicModelId | 输入 |
|---|---|---|
| GPT Image 2 多参考图生成 | `public_model_gpt_image_2` | 至少两张参考图 |
...
| `init --skill-name gpt-image-2-multi-reference-image` | 初始化 API Key |
...
python3 "$SKILL_PATH/scripts/imagegen.py" generate \
  --prompt "使用 GPT Image 2 制作高完成度多参考图生成，主体准确，构图清晰" \
...
| 能力 | publicModelId |
|---|---|
| GPT Image 2 多参考图生成 | `public_model_gpt_image_2` |
