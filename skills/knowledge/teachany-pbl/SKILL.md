---
name: teachany-pbl
description: Decompose a PBL project goal via teachany.cn into a knowledge-path
  PNG and editable link. Use for 项目式学习拆解、知识路径图谱、PBL 拆解、课标对齐项目路径. Not for generic
  lesson plans or interactive courseware HTML.
version: 1.0.0
compatibility: Python 3.9+, playwright + chromium, network access to www.teachany.cn
display_name: TeachAny PBL
display_name_en: TeachAny PBL
description_zh: 通过 teachany.cn 将 PBL 项目目标拆解为知识路径图谱、PNG 长图和可编辑链接。适用于项目式学习拆解、课标对齐项目路径等场景。
description_en: Decompose a PBL project goal via teachany.cn into a
  knowledge-path PNG and editable link. Use for project-based learning
  decomposition and curriculum-aligned project planning.
visibility: public
