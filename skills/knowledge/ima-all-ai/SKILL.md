...
requires:
  ...
  credentialNote: |
    IMA_API_KEY is sent to api.imastudio.com for product/task APIs and to imapi.liveme.com only when image/video tasks need local image uploads.
persistence:
  readWrite:
...
skill_id: official_q8xSx7e8
enabled_at: 1787232404981
name_zh: IMA 工作室
---
