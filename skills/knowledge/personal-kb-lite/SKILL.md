...
description: |
  Local file knowledge base with LLM-powered indexing and Q&A. Scans a directory for documents (.txt, .md, .pdf, .docx, .xlsx, .csv), extracts metadata (summary, tags, table of contents) using the LLM, and answers questions by retrieving relevant files.
version: 1.0.0
metadata:
  openclaw:
    requires:
...
skill_id: official_0l8jGdUp
enabled_at: 1787230928612
name_zh: 轻量级个人知识库
---
