---
name: wechat-search
display_name: 公众号热门文章查询
display_name_en: WeChat Article Search
description: 公众号热门文章查询工具，支持按关键词搜索爆款文章，展示推荐热门文章，助力内容创作者把握趋势与获取灵感；当用户需要搜索公众号文章、查找爆款内容、获取创作灵感时使用
description_zh: 按关键词搜索公众号爆款文章，支持三维评分排序、时间范围筛选和定时订阅推送。
description_en: Search WeChat viral articles by keyword. Features
  three-dimensional scoring, time range filtering, and scheduled subscription
  push.
category: search
version: 1.0.2
author: 红狐数据
