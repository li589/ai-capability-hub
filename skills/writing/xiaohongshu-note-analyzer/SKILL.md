...
dependency:
  python: []
display_name: 小红书笔记优化助手
display_name_en: Xiaohongshu Note Analyzer
description_zh: 基于全网爆款数据对小红书文案多维度评分并给出优化建议
description_en: Score and optimize Xiaohongshu copywriting based on trending data
category: writing
version: 1.0.0
author: 红狐数据
