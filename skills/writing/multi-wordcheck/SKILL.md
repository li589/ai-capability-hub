...
dependency:
  ...
  external_sensitive_word_api: null
...
description_en: Detect sensitive words against official lists for WeChat,
  Xiaohongshu and Douyin, with replacement suggestions.
category: writing
author: 红狐数据
...
1. 请前往 [红狐hub](https://redfox.hk/settings/api-keys?source=workbuddy) 获取API KEY
