...
display_name: 小红书每日爆款笔记
display_name_en: XHS Daily Top Notes
description_zh: 追踪小红书各领域每日爆款笔记，监测赛道热度变化，提炼选题与创作灵感
description_en: Track daily viral Xiaohongshu notes by category for content inspiration.
...
- [红狐Hub](https://redfox.hk?source=workbuddy) 账号与 API Key（格式 `ak_xxxxxxxx`，新用户注册赠免费积分）
...
**获取 API Key**：访问 [红狐Hub官网](https://redfox.hk/?source=workbuddy) → [注册/登录](https://redfox.hk/login?source=workbuddy) → 个人中心复制 Key。
