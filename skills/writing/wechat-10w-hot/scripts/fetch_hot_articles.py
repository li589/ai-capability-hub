...
def fetch_articles_by_category(category: str, start_date: str, end_date: str, source: str = "公众号10w+阅读文章推荐-WorkBuddy") -> list:
    """
    根据分类和时间获取文章数据
...
def main():
    ...
    parser.add_argument("--source", type=str, default="公众号10w+阅读文章推荐-WorkBuddy",
                        help="数据来源")
