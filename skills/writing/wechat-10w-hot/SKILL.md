---
name: wechat-10w-hot
display_name: 公众号10w+文章
display_name_en: WeChat 100K+ Hot Articles
description: 全网持续收录每日超过1000+公众号10w+文章内容，向用户推送公众号达到10w+阅读的热门文章；当用户需要获取全领域的公众号热门文章、或订阅每日10w+文章推送、特定领域爆款文章时使用
description_zh: 全网持续收录每日1000+条公众号10w+文章，支持23个领域分类查询、智能爆款规律分析和HTML报告导出。
description_en: Daily collection of 1000+ WeChat articles with 100K+ reads.
  Supports 23 category filters, viral pattern analysis, and HTML report export.
category: data
version: 1.0.1
author: 红狐数据
