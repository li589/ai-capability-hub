...
display_name: 抖音热门账号推荐
display_name_en: Douyin Top Accounts
...
description_zh: 抖音最具影响力账号榜单工具，支持日榜/周榜/月榜TOP50查询、赛道筛选与HTML报告下载。
description_en: Douyin top account ranking tool with daily/weekly/monthly TOP50
  lists, category filters and downloadable HTML reports.
category: data
version: 1.0.2
author: 红狐数据
dependency: {}
...
**Q: 如何配置 API Key？**
A: 请前往 [红狐hub](https://redfox.hk/settings/api-keys?source=workbuddy) 获取 API KEY，然后通过环境变量 `REDFOX_API_KEY` 配置。
