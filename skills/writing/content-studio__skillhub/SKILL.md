---
name: "图文内容规划助手"
description: "输入主题、资料或业务说明，付费后整理图文选题、标题备选、正文结构、封面文案和发布清单。"
tags: ["图文内容"]
version: "1.0.1"
...
本技能按调用量计费，每次 3 元。输出用于内容整理和写作参考，不承诺平台审核、流量、交易或收益结果。
...
`POST https://api.skillpayapi.top/v1/skills/content-studio/invoke`

`Content-Type: application/json`

Body 必须为：

`{"skill_id":"content-studio","input":"<用户本次完整需求>","mode":"full"}`
...
- `1.0.1`：收窄公开描述，保留 X402 付费流程与后端履约契约。
