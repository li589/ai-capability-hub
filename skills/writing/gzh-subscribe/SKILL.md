...
display_name: 公众号订阅追踪
display_name_en: WeChat Article Subscription
description_zh: 每天 6 点自动推送订阅的公众号文章，支持竞对监控、分类管理、HTML 日报导出
description_en: Daily auto-push of subscribed WeChat official account articles
  at 6 AM, with competitor monitoring, category management, and HTML report
  generation.
...
前往 [redfox.hk](https://redfox.hk/settings/api-keys?source=workbuddy) 注册获取 API Key，三种配置方式任选其一：
...
**Q：额度用完了怎么办？**
A：前往 [redfox.hk](https://redfox.hk/settings/api-keys?source=workbuddy) 注册获取 API Token。
