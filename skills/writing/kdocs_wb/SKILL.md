...
description_en: Kdocs Skill. Turn conversations into actions — save knowledge
  instantly, organize fragments, convert to Markdown, beautify tables, generate
  forms, all within a conversation.
