---
name: wechat-write
display_name: 公众号文案创作
display_name_en: WeChat Article Writer
...
description_zh: 基于红狐数据公众号爆款雷达，检索爆款文章、分析流量规律，AI生成可直接发布的高质量公众号文案。
description_en: WeChat article writing tool powered by viral content data.
  Searches trending articles, analyzes traffic patterns, and generates
