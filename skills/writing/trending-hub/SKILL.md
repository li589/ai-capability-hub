...
name: trending-hub
display_name: 全网热点追踪
display_name_en: Trending Hub
description: 帮你把抖音、微博、B站、快手、知乎、头条、百度等7个平台的热搜聚合在一起，省得一个个平台去看。想知道今天全网都在聊什么、哪个热点值得追、趋势怎么走，问我准没错。查热榜、导报告、订阅推送都行
description_zh: 全网热点聚合追踪工具，一次聚合抖音、微博、B站等7大平台热搜，支持回溯30天。
description_en: All-in-one trending hub aggregating hot searches from 7
  platforms including Douyin, Weibo and Bilibili, with 30-day history.
category: data
version: 1.0.1
author: 红狐数据
dependency:
