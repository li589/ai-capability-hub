---
name: wechat-title
display_name: 公众号标题生成与评分
display_name_en: WeChat Title Generator
description: 基于热门数据生成公众号爆款标题或对用户标题进行多维度评分的专业工具。当用户需要生成公众号标题、查询爆款内容、分析热门趋势、获取创作灵感、参考爆款规律时使用。触发词：公众号标题、爆款标题、标题生成、标题评分、公众号爆款。
description_zh: 公众号爆款标题生成与评分工具，基于真实热门数据生成标题并进行多维度打分。
description_en: WeChat viral title generator and scorer based on real trending
  article data, with multi-dimensional scoring.
category: writing
version: 1.0.1
author: 红狐数据
dependency:
