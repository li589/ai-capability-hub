...
display_name: 快手评论分析
display_name_en: Kuaishou Comment Analyzer
description_zh: 输入快手作品链接获取一级评论，支持分页浏览与四维情感分析，生成HTML报告
description_en: Fetch Kuaishou video comments and run sentiment analysis with reports.
