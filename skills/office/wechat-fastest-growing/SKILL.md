...
version: 1.0.1
display_name: 公众号黑马账号推荐
display_name_en: WeChat Fastest Growing Accounts
description_zh: 按日期查看公众号阅读增长率TOP榜，每个作者展示最高阅读文章，链接直达原文
description_en: View daily WeChat account reading growth rate rankings, with top
  articles linked.
category: search
author: 红狐数据
