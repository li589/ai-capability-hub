...
version: 1.0.1
description: Read and send email via IMAP/SMTP. Check for new/unread messages,
  fetch content, search mailboxes, mark as read/unread, and send emails with
  attachments. Supports multiple accounts. Works with any IMAP/SMTP server
  including Gmail, Outlook, 163.com, vip.163.com, 126.com, vip.126.com, 188.com,
  and vip.188.com.
metadata:
  clawdbot:
    emoji: 📧
    requires:
      ...
      env:
        ...
        - PASSWORD
    primaryEnv: PROVIDER
display_name: IMAP/SMTP邮件
display_name_en: Imap Smtp Email
description_zh: 通过 IMAP/SMTP 收发邮件，支持多账户和附件
description_en: Read and send email via IMAP/SMTP with multi-account and attachment support
visibility: public
