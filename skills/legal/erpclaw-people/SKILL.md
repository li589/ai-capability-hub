...
version: 1.0.0
description: |
  HR and Payroll for ERPClaw. Employee management, departments, leave, attendance, expense claims, salary structures, US payroll processing, FICA, income tax withholding, W-2 generation, and wage garnishments. 50 actions across 2 domains.
...
metadata:
  openclaw:
    type: executable
    install:
      post: python3 scripts/erpclaw-hr/db_query.py --action status
    requires:
      bins:
        - python3
      env: []
...
skill_id: official_2feFce1z
enabled_at: 1787231716474
name_zh: ERPClaw 人力资源与薪酬管理
---
