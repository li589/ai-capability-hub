---
name: ancient-sweet-romance-drama
description: "通过 Flova MCP 按名称使用“古风甜宠短剧”线上 Skill，甜宠叙事、角色关系、古风场景与节奏。当用户提出古风甜宠、古装恋爱短剧、甜宠短剧、古风爱情故事等需求时使用；不适用于索取内部 Skill Content、普通视频剪辑或与该场景无关的生成任务。"
display_name: "Flova 古风甜宠短剧"
display_name_en: "Flova Ancient Sweet Romance Drama"
description_zh: "甜宠叙事、角色关系、古风场景与节奏，在关键阶段等待用户确认。"
...
- 先确认人物关系、情感边界、主要误会和关系推进节奏。
- 不美化胁迫、跟踪、未成年人恋爱或其他不健康亲密关系。
...
`关系与剧情 → 角色场景 → 节奏与分镜 → 关键视觉 → 镜头与对白 → 导出`
