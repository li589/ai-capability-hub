...
- `REDFOX_API_KEY` is issued by [RedFox Hub](https://redfox.hk/settings/api-keys?source=workbuddy) (`https://redfox.hk`?source=workbuddy).
- Register at [RedFox Hub](https://redfox.hk?source=workbuddy) to obtain `REDFOX_API_KEY`.
