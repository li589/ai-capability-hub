...
display_name: B站搜账号下作品集
display_name_en: Bilibili Creator Works
description_zh: 根据UP主UID实时获取其最新视频作品列表，支持游标翻页，按播放量降序排列
description_en: Fetch a Bilibili creator's latest videos by UID with cursor-based paging.
category: search
version: 1.0.0
author: 红狐数据
---
