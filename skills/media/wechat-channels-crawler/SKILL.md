...
display_name: 视频号作品查询
display_name_en: WeChat Channels Search
description_zh: 根据关键词搜索视频号热门作品，支持多种排序方式展示互动数据
description_en: Search trending WeChat Channels videos by keywords with sorting and analytics
category: search
version: 1.0.0
author: 红狐数据
...
**获取方式：** 前往 [红狐hub](https://redfox.hk/settings/api-keys?source=workbuddy) 注册并获取 API Key。
