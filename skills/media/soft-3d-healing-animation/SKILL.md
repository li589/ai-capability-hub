---
name: soft-3d-healing-animation
description: "通过 Flova MCP 按名称使用“软萌 3D 治愈动画”线上 Skill，软萌角色、治愈情绪与 3D 连续性。当用户提出软萌 3D 动画、治愈动画、可爱角色短片、温暖 3D 故事等需求时使用；不适用于索取内部 Skill Content、普通视频剪辑或与该场景无关的生成任务。"
display_name: "Flova 软萌 3D 治愈动画"
display_name_en: "Flova Soft 3D Healing Animation"
description_zh: "软萌角色、治愈情绪与 3D 连续性，在关键阶段等待用户确认。"
...
- 名称：`软萌 3D 治愈动画`
- 能力摘要：这是一个帮助用户从 0 到 1 完成一条软萌、温暖、可爱、有故事感的 3D 治愈动画内容的skill。
...
- 优先锁定角色比例、材质、表情、色彩和场景连续性。
- 涉及儿童形象时保持安全、非性化和适龄表达。
