...
display_name: YouTube视频评论分析
display_name_en: YouTube Comment Analyzer
description_zh: 输入YouTube视频链接获取评论数据，支持翻页续查与四维情感分析
description_en: Fetch YouTube video comments with paging and four-dimension sentiment.
...
A: 当前版本仅支持一级评论，嵌套回复暂不展开显示。如需完整数据可前往红狐hub[企业服务](https://redfox.hk/dashboard/enterprise?source=workbuddy)对接咨询。
