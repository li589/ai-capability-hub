...
display_name: 短视频下载器
display_name_en: Video Downloader
description_zh: 支持抖音、小红书、B站等十多平台无水印短视频和图文下载，开箱即用
description_en: Download watermark-free videos from Douyin, Xiaohongshu,
  Bilibili, YouTube and more
category: media
version: 1.0.1
author: 红狐数据
...
通过 [redfox.hk](https://redfox.hk/settings/api-keys?source=workbuddy) API 解析并下载主流短视频平台的无水印视频/图文。
...
可访问 [redfox.hk](https://redfox.hk/settings/api-keys?source=workbuddy) 注册获取个人 API Key：
...
本工具基于 [redfox.hk](https://redfox.hk/settings/api-keys?source=workbuddy) 的 `parseWork/parse` 接口构建。前往官网查看更多 API 能力和使用文档。
