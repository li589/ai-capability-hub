...
display_name: 小红书视频下载
display_name_en: XHS Video Downloader
description_zh: 粘贴小红书视频链接，一键解析返回无水印视频下载链接
description_en: Paste a Xiaohongshu video link to get a watermark-free download URL.
category: media
version: 1.0.0
author: 红狐数据
---
...
粘贴小红书视频链接，一键获取无水印视频下载直链。通过 [redfox.hk](https://redfox.hk/settings/api-keys?source=workbuddy) 服务解析，支持单个或批量链接处理，自动识别并校验小红书视频链接。
