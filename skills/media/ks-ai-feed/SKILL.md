...
display_name: AI快手信息源
display_name_en: Kuaishou AI Feed
description_zh: 每日自动扫描快手AI创作内容，按播放量筛选爆款并智能聚类，生成HTML日报与情报洞察
description_en: Daily scan of Kuaishou AI content, filter trending videos by views, auto-cluster topics, generate HTML report with AI insights
...
前往 [redfox.hk/login](https://www.redfox.hk/login?source=workbuddy) 注册获取 API Token,然后配置:
