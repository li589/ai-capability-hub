...
description: YouTube视频下载 — 粘贴 YouTube 视频链接，一键解析返回无水印视频下载链接（支持多种清晰度）。当用户需要下载
  YouTube 视频、保存油管视频、获取 YouTube
  视频直链时使用。触发词：YouTube视频下载、油管视频下载、yt视频下载、YouTube视频解析、下载YouTube视频、youtube视频下载。
display_name: YouTube视频下载
display_name_en: YouTube Video Downloader
description_zh: 粘贴 YouTube 视频链接，一键解析返回无水印下载链接，支持多种清晰度
description_en: Paste a YouTube video link to get watermark-free download URLs
