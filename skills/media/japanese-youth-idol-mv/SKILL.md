---
name: japanese-youth-idol-mv
description: "通过 Flova MCP 按名称使用“日系青春偶像MV”线上 Skill，青春偶像、表演、场景切换与音乐节拍。当用户提出日系青春偶像 MV、校园偶像视频、平成青春感、女子团体 MV等需求时使用；不适用于索取内部 Skill Content、普通视频剪辑或与该场景无关的生成任务。"
display_name: "Flova 日系青春偶像MV"
display_name_en: "Flova Japanese Youth Idol Music Video"
description_zh: "青春偶像、表演、场景切换与音乐节拍，在关键阶段等待用户确认。"
...
- 名称：`日系青春偶像MV`
- 能力摘要：适用于制作平成时代AKB48风格青春偶像MV，融合日系胶片质感、纪录片手持摄影、校园青春叙事与女子团体群像感。
...
- 重点表达青春群像、校园场景、胶片质感、手持摄影和表演节奏。
- 不仿冒真实艺人或团体，不复制既有歌曲、舞蹈、服装、Logo 或 MV 镜头。
...
`音乐与人设 → 造型场景 → 节拍分镜 → 关键视觉 → 表演镜头 → MV 导出`
