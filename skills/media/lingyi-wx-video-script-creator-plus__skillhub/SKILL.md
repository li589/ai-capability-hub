---
name: 视频号挂车爆单短视频脚本生成【零一数科·出品】
description: 【零一数科·出品】视频号挂车爆单短视频脚本生成。一条链接二创脚本，丢进爆款视频号链接即以此骨架改写成你的挂车脚本，或按方向/目的/商品原创多条口播脚本（含分段表、口播全文、六维质检评分）。付费版远端生成，约 98 点/次。
metadata:
  slug: lingyi-wx-video-script-creator-plus
  version: v0.3.0
