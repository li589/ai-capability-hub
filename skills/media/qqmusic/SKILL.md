---
name: qqmusic
description: QQ Music — search songs, albums, playlists, music videos, artists;
  daily recommendations; music charts & rankings; AI-powered playlists;
  personalized listening reports & music insights.
  QQ音乐助手：搜索、每日推荐、排行榜、AI歌单、听歌报告、AI解读。
version: 0.0.3
display_name: QQ音乐助手
display_name_en: QQ Music
description_zh: QQ音乐官方智能助手，支持歌曲搜索、每日推荐、AI歌单、排行榜、听歌报告与AI音乐解读。
description_en: "Official QQ Music assistant: search songs, daily
  recommendations, AI-powered playlists, charts, listening reports, and AI music
  interpretation."
visibility: public
