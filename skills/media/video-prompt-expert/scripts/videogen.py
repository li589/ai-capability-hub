...
SOURCE = "视频生成提示词专家-WorkBuddy"
VIDEO_SOURCE = "视频生成提示词专家-视频生成-WorkBuddy"
...
Examples:
  ...
  python3 videogen.py "ignored" --task-id vg_abc123def456
    ...
    parser.add_argument("--api-key", help="API Key (前往 https://redfox.hk/settings/api-keys?source=workbuddy 注册获取)")
