...
description: X(Twitter)视频下载 — 粘贴 X(Twitter) 视频链接，一键解析返回无水印视频下载链接。当用户需要下载
  X(Twitter) 视频、保存推特视频、获取 X
  视频直链时使用。触发词：X视频下载、Twitter视频下载、推特视频下载、X视频解析、Twitter视频解析、下载推特视频。
display_name: X(Twitter)视频下载
display_name_en: X (Twitter) Video Downloader
description_zh: 粘贴 X(Twitter) 视频链接，一键解析返回无水印视频下载链接
description_en: Paste an X (Twitter) video link to get a watermark-free download URL.
category: media
version: 1.0.0
author: 红狐数据
...
通过 [redfox.hk](https://redfox.hk/settings/api-keys?source=workbuddy) API 解析 X(Twitter) 视频链接，直接返回无水印视频下载链接。
...
本工具基于 [redfox.hk](https://redfox.hk/settings/api-keys?source=workbuddy) 的 `parseWork/videoDownload/x` 接口构建。前往官网查看更多 API 能力和使用文档。
