...
skill_id: official_7q8AWHr6
enabled_at: 1787231121072
version: 1.0.0
name_zh: 品牌故事视频生成模板
---
# Brand Story Video
...
This skill provides a high-quality, manually crafted prompt template for AI sora2 video generation.
...
```text
Create a 60-second brand story video using Sora2 for {brand_name} and {product_name}.
...
```text
Create a 60-second brand story video using Sora2 for {{brand_name}} and {{Premium Wireless Earbuds}}.
...
sora2, video, brand-story, narrative
