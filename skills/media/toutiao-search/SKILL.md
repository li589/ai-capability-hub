---
name: toutiao-search
display_name: 今日头条爆款内容查询
display_name_en: Toutiao Hot Search
description: 今日头条爆款内容查询 — 输入关键词搜索今日头条最新作品（图文/视频），支持按阅读量/时间排序、限定时间范围，终端表格展示 + CSV
  导出 + 交互式 HTML 报告。当用户需要搜索今日头条热门内容、追踪头条热点、分析爆款文章时使用。
description_zh: 今日头条爆款内容查询工具，关键词搜索最新作品，支持排序筛选、CSV导出与HTML报告。
description_en: Toutiao hot content search tool. Search the latest works by
  keyword with sorting, time filters, CSV export and HTML report.
category: search
version: 1.0.1
author: 红狐数据
