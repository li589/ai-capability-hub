...
- `REDFOX_API_KEY` is provided by [RedFox Hub](https://redfox.hk/settings/api-keys?source=workbuddy).
- Register at [RedFox Hub](https://redfox.hk?source=workbuddy) to obtain your `REDFOX_API_KEY`.
