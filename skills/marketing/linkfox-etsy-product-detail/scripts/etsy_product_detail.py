#!/usr/bin/env python3
"""
Etsy Product Detail Lookup - LinkFox Skill
...
API_PATH = "/etsy/product/detail"
SLUG = "linkfox-etsy-product-detail"
...
def main():
    ...
    if not argv:
        print(
            "Usage: etsy_product_detail.py '<JSON parameters>' [--inline]",
            file=sys.stderr,
        )
        sys.exit(1)
