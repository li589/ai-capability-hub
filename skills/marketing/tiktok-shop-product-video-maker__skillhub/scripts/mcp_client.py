...
PACKAGE_DISCOVERY_URL = "https://beatra.ai/skills/tiktok-shop-product-video-maker/channels/skillhub/install.json"
PACKAGE_CDN_BASE_TEMPLATE = "https://cdn.beatra.ai/agent-packages/tiktok-shop-product-video-maker/channels/skillhub/v{version}"
