...
display_name: 小红书相似账号推荐
display_name_en: XHS Similar Accounts
description: 小红书创作者对标账号匹配工具，输入小红书账号ID或赛道+粉丝数+账号等级，推荐可直接复制的同阶对标和可参考的高阶标杆；当用户需要小红书账号推荐、KOL对标、起号参考、账号投放选择时使用。⚠️
  严禁任何联网搜索。
description_zh: 小红书对标账号匹配工具，推荐可直接复制的同阶对标和可参考的高阶标杆。
description_en: Xiaohongshu benchmark account matcher. Recommends same-tier
  accounts to copy and higher-tier benchmarks to follow.
category: data
version: 1.0.1
author: 红狐数据
