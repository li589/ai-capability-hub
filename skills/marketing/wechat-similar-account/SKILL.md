...
display_name: 公众号相似账号推荐
display_name_en: WeChat Similar Account Finder
description_zh: 基于三层加权匹配体系为公众号推荐同阶对标账号和高阶标杆账号
description_en: Find benchmark WeChat accounts with 3-layer weighted matching
...
适用于公众号创作者、内容运营、账号投放决策等需要对标参考的场景。基于 [RedFox](https://redfox.hk/?source=workbuddy) 数据平台提供支持。
...
- 红狐Hub API Key（前往 [RedFox 官网](https://redfox.hk/?source=workbuddy) 注册获取，新用户赠送免费积分）

### 获取 API Key
1. 访问 [红狐Hub 官网](https://redfox.hk/?source=workbuddy) 了解服务详情
2. 前往 [注册页面](https://redfox.hk/login?source=workbuddy) 注册账号
...
| **数据源** | 红狐数据 API（https://redfox.hk/?source=workbuddy） |
...
A: 请按以下步骤配置：
1. 访问 https://redfox.hk/?source=workbuddy 注册账号并获取 API Key
...
2. 确认网络可以正常访问 https://redfox.hk/?source=workbuddy
...
如有其他问题，可通过以下方式获取帮助：
- 📧 访问 [红狐数据 官网](https://redfox.hk/?source=workbuddy) 了解更多
