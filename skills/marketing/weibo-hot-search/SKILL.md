...
description: 微博热搜榜单查询工具。调用 Redfox
  接口获取微博当前热搜榜单，按排名展示热搜标题及跳转链接，并对热搜内容进行创作灵感分析总结。当用户需要查看微博热搜、微博热榜、微博热门话题时使用。触发词：微博热搜、微博热榜、微博热门话题、热搜榜、微博热搜榜。
display_name: 微博热搜
display_name_en: Weibo Hot Search
description_zh: 获取微博当前热搜榜单，按排名展示热搜标题及链接，并提供创作灵感分析
description_en: Fetch Weibo trending topics with rankings, links, and creative
