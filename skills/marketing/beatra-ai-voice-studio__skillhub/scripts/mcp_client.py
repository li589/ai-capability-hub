...
PACKAGE_DISCOVERY_URL = "https://beatra.ai/skills/beatra-ai-voice-studio/channels/skillhub/install.json"
PACKAGE_CDN_BASE_TEMPLATE = "https://cdn.beatra.ai/agent-packages/beatra-ai-voice-studio/channels/skillhub/v{version}"
