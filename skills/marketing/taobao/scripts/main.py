...
# 修复 Windows GBK 环境下 print 中文/特殊字符的 UnicodeEncodeError
...
async def main():
    ...
    async with aiohttp.ClientSession(headers=HEADERS) as SESSION:
        ...
        search_parser.add_argument("--source", default="0", help="来源 0:全部 1:淘宝 2:京东 3:拼多多 4:苏宁 5:唯品会 7:抖音 8:快手")
        ...
        detail_parser.add_argument("--source", default="1", help="来源 1:淘宝 2:京东 3:拼多多 4:苏宁 5:唯品会 7:抖音 8:快手")
