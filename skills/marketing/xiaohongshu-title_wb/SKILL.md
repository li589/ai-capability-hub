...
dependency:
  python: null
  system: null
display_name: 小红书标题生成
display_name_en: XHS Title Generator
description_zh: 基于用户输入的任何信息，生成符合平台流量逻辑的小红书爆款标题
description_en: Generate viral Xiaohongshu titles from any user input.
category: writing
version: 1.0.0
author: 红狐数据
