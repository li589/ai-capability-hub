---
name: ecomseer
description: "TikTok Shop e-commerce data assistant. Search products, find
  trending items, analyze influencers, explore shops, track video performance,
  and get ad insights via ecomseer.com. Triggers: 找商品, 搜商品, 爆品, 带货, TikTok电商,
  达人分析, 视频带货, 店铺分析, 广告素材, 销量榜, 跨境电商, search products, find trending, TikTok
  Shop, influencer analysis, shop data, ad creatives, sales ranking, e-commerce
  analytics, product research."
metadata:
  openclaw:
    emoji: 🛒
    primaryEnv: ECOMSEER_API_KEY
version: 1.0.1
display_name: EcomSeer TikTok 电商数据
display_name_en: Ecomseer
description_zh: TikTok Shop 电商数据：商品/爆品/达人/店铺/广告全链路分析
description_en: "TikTok Shop e-commerce intelligence: products, trends,
  influencers, shops, ads"
visibility: public
icon: https://codebuddy-platform-1258344699.cos.accelerate.myqcloud.com/public/45edac6b-2078-4678-89f3-6f9800cf5e5f/avatar/skill/au_7a9f13ce-588.png
