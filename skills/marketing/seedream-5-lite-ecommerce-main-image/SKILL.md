...
description: 基于 Seedream 5.0 Lite 电商主图 的 AI 图片生成与编辑器，固定调用 Seedream 5.0 Lite
  的电商主图裸接口能力。当用户需要 Seedream 5.0 Lite、Seedream 5 Lite、Seedream5、即梦图片
  5、字节图片模型、电商主图、商品主图、电商首图、白底图、SKU主图、平台主图、AI图片、AIGC图片 时使用此 Skill。
description_zh: 基于 Seedream 5.0 Lite 电商主图 的 AI 图片生成与编辑器，固定调用 Seedream 5.0 Lite
  的电商主图裸接口能力。当用户需要 Seedream 5.0 Lite、Seedream 5 Lite、Seedream5、即梦图片
  5、字节图片模型、电商主图、商品主图、电商首图、白底图、SKU主图、平台主图、AI图片、AIGC图片 时使用此 Skill。
version: 1.0.0
...
- 独立占据 `seedream-5-lite-ecommerce-main-image` 搜索入口
- 固定调用 `public_model_seedream_5_0_lite`，不使用其他模型冒充
...
| 能力 | publicModelId | 输入 |
|---|---|---|
| Seedream 5.0 Lite 电商主图 | `public_model_seedream_5_0_lite` | 文字或可选参考图 |
...
| `init --skill-name seedream-5-lite-ecommerce-main-image` | 初始化 API Key |
...
python3 "$SKILL_PATH/scripts/imagegen.py" generate \
  --prompt "使用 Seedream 5.0 Lite 制作高完成度电商主图，主体准确，构图清晰"
```
...
| 运行环境 | Python 3.6+ |
| HTTP 库 | requests |
| 模型 | public_model_seedream_5_0_lite |
...
| 能力 | publicModelId |
|---|---|
| Seedream 5.0 Lite 电商主图 | `public_model_seedream_5_0_lite` |
...
**Q4：会自动换模型吗？** 不会，本 Skill 固定 `public_model_seedream_5_0_lite`。
