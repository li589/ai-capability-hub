...
class TokenManager:
    ...
    def _normalize_base_url(base_url: str) -> str:
        """归一化 base_url，避免缓存键受尾部斜杠影响。"""
        return (base_url or "https://open.wshoto.com").rstrip("/")
    ...
    def _load_cache(self) -> Optional[dict[str, Any]]:
        ...
        try:
            ...
            # 校验缓存是否属于当前 base_url，避免跨环境复用旧 token
            if self._normalize_base_url(data.get("base_url", "")) != self.base_url:
                return None
            return data
