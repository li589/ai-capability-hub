...
- **原始**：[vendorRealTimeTrafficReport.json](https://raw.githubusercontent.com/amzn/selling-partner-api-models/main/schemas/reports/vendorRealTimeTrafficReport.json)
- **目录浏览**：https://github.com/amzn/selling-partner-api-models/tree/main/schemas/reports

## Schema 摘要

本报告以小时粒度共享买家访问供应商商品详情页的流量数据。请求可跨越多个日期范围周期。例如，若客户指定的 `dataStartTime` 与 `dataEndTime` 跨度为 3 小时，则报告将包含该时间跨度内每个完整小时的数据。
