...
Search Terms（搜索词）报告按搜索关键词和类目，分享某站点下点击量排名前 3 的 ASIN 数据。数据可按不同日期范围聚合级别获取：DAY、WEEK、MONTH、QUARTER。请求不能跨多个周期。例如，WEEK 级别的请求不能从 2021-06-06 开始到 2021-06-19 结束，因为该请求跨越了两周。
