...
- **原始**：[vendorRealTimeInventoryReport.json](https://raw.githubusercontent.com/amzn/selling-partner-api-models/main/schemas/reports/vendorRealTimeInventoryReport.json)
- **目录浏览**：https://github.com/amzn/selling-partner-api-models/tree/main/schemas/reports

## Schema 摘要

本报告以 ASIN 维度共享库存数据，聚合粒度为小时。请求可跨越多个日期范围周期，包括当天。
