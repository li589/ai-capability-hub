...
- **原始**：[vendorNetPureProductMarginReport.json](https://raw.githubusercontent.com/amzn/selling-partner-api-models/main/schemas/reports/vendorNetPureProductMarginReport.json)
- **目录浏览**：https://github.com/amzn/selling-partner-api-models/tree/main/schemas/reports

## Schema 摘要

净纯产品利润率（Net Pure Product Margin）报告以聚合维度（覆盖供应商全部商品目录）和按 ASIN 维度，向供应商共享亚马逊销售其商品时的利润率数据。数据支持不同的日期范围聚合粒度：DAY、WEEK、MONTH、QUARTER、YEAR。请求可跨越多个日期范围周期。
