...
- **原始**：[vendorRealTimeSalesReport.json](https://raw.githubusercontent.com/amzn/selling-partner-api-models/main/schemas/reports/vendorRealTimeSalesReport.json)
- **目录浏览**：https://github.com/amzn/selling-partner-api-models/tree/main/schemas/reports

## Schema 摘要

本报告以 ASIN 维度共享销售数据，聚合粒度为小时。请求可跨越多个日期范围周期。例如，若客户指定的 `dataStartTime` 与 `dataEndTime` 跨度为 3 小时，则报告将包含该时间跨度内每个完整小时的数据。
