...
Search Catalog Performance（搜索目录表现）报告提供你所指定日期范围内的搜索互动指标，例如曝光、点击、加购与购买。数据可按不同报告周期获取：WEEK、MONTH 和 QUARTER。请求不能跨多个周期。例如，WEEK 级别的请求不能从 2025-01-05 开始到 2025-01-18 结束，因为该请求跨越了两周。
