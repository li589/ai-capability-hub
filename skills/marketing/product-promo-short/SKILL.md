---
name: product-promo-short
description: "通过 Flova MCP 按名称使用“商品宣传短片”线上 Skill，商品图片、卖点、受众、品牌与评审节点。当用户提出商品宣传片、产品短视频、电商广告、商品卖点视频等需求时使用；不适用于索取内部 Skill Content、普通视频剪辑或与该场景无关的生成任务。"
display_name: "Flova 商品宣传短片"
display_name_en: "Flova Product Promo Short"
description_zh: "商品图片、卖点、受众、品牌与评审节点，在关键阶段等待用户确认。"
...
- 名称：`商品宣传短片`
- 能力摘要：基于上传的产品图片制作商业视频。Nano Banana + Seedance 2.5（分辨率 480p）。在关键阶段暂停以获取用户确认；通过“单镜头流水线”实现人机协作。
...
- 开始前确认产品素材、核心卖点、目标受众、投放渠道和品牌限制。
- 不编造未提供或无法验证的功效、参数、认证、价格和用户评价。
