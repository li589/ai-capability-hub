...
用法:
    python scripts/generate_hashes.py              # 为当前平台生成哈希
    python scripts/generate_hashes.py --output requirements.txt  # 直接写入文件
    python scripts/generate_hashes.py --packages pandas==3.0.1 numpy==2.4.3
"""
