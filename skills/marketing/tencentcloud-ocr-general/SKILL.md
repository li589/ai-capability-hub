...
description_en: Tencent Cloud AdvertiseOCR API for text recognition in images.
  Supports horizontal, vertical, tilted, and rotated (90/180/270 degree) text
  recognition with polygon coordinates and confidence scores.
visibility: public
