---
name: wechat-cover
display_name: 公众号爆款封面设计
display_name_en: WeChat Viral Cover Designer
...
description_zh: 基于全网每日收录的10w+爆款文章数据，分析同赛道封面视觉元素，AI生成高转化封面设计方案。
description_en: AI-powered WeChat cover design tool based on daily viral article
  data. Analyzes visual patterns and generates high-conversion cover designs.
category: design
version: 1.3.1
author: 红狐数据
