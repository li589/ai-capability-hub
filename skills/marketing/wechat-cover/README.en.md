...
- `REDFOX_API_KEY` is provided by [RedFoxHub](https://redfox.hk/settings/api-keys?souce=workbuddy) (`https://redfox.hk`).
- Please visit [RedFoxHub](https://redfox.hk?souce=workbuddy) to register an account and obtain `REDFOX_API_KEY`.
