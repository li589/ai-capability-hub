...
- `REDFOX_API_KEY` 由 [红狐 hub](https://redfox.hk/settings/api-keys?souce=workbuddy) (`https://redfox.hk`)提供。
- 请前往 [红狐 hub](https://redfox.hk?souce=workbuddy) 注册账号，获取 `REDFOX_API_KEY`。
