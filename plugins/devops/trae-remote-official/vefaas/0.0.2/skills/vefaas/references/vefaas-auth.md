...
AK/SK 方案详细说明（含权限配置、最佳实践）：https://bytedance.larkoffice.com/wiki/IxGEwkEFqijkJpk6wjac3Rtun9e
...
2. 建议用户改用 AK/SK 登录后重试：
   ...
   vefaas login --accessKey <AK> --secretKey <SK>
   ```
3. 告知 AK/SK 可在 IAM Access Key 管理页获取：https://console.volcengine.com/iam/keymanage ；详细方案参见：https://bytedance.larkoffice.com/wiki/IxGEwkEFqijkJpk6wjac3Rtun9e
