...
function printUsage() {
  console.log(`Usage:
  node scripts/validate-scene-style.mjs --scene <file.excalidraw> [options]

Options:
  --diagram-theme <id>  Diagram Theme id. Defaults to the manifest default.
  --theme-manifest <f>  Override the bundled theme manifest.
  --strict              Exit with code 1 when style violations are found.
  --help                Show this help.`);
}
...
async function main() {
  ...
  const result = validateSceneStyles(scene, diagramTheme);
